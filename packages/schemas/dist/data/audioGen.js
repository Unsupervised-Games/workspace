...
export const POST_CHAIN_PRESETS = [
    // ── Voice ──────────────────────────────────────────────
    {
        id: 'voice-broadcast',
        name: 'Voice — broadcast',
        description: 'EBU R128 broadcast loudness. Mixes cleanly under music + SFX. Conservative dynamics; voice de-rumble at 80Hz.',
        appliesTo: ['voice'],
        chain: {
            normalizeLufs: -23,
            fadeInMs: 20,
    ...
    },
    {
        ...
        description: 'YouTube / Spotify-style web target. Punchier presence; tames 200Hz mud.',
        appliesTo: ['voice'],
        chain: {
            normalizeLufs: -16,
            fadeInMs: 50,
    ...
    },
    {
        ...
        description: 'Wide-dynamics cinematic dialogue. Preserves breath + room sense; subtle 8kHz air.',
        appliesTo: ['voice'],
        chain: {
            normalizeLufs: -20,
            loudnessRangeLu: 11,
    ...
    },
    {
        ...
        description: 'Tight, intelligibility-first. Aggressive de-rumble; 3kHz presence boost cuts through busy mixes.',
        appliesTo: ['voice'],
        chain: {
            normalizeLufs: -16,
            eq: [
    ...
    // ── Music ──────────────────────────────────────────────
    {
        ...
        description: 'Standard game-music master. Modest fades for scene crossfade safety.',
        appliesTo: ['music'],
        chain: {
            normalizeLufs: -16,
            fadeInMs: 100,
    ...
    },
    {
        ...
        description: 'Spotify / Apple Music loud master. Long fades for menu / cinematic intros.',
        appliesTo: ['music'],
        chain: {
            normalizeLufs: -14,
            fadeInMs: 200,
    ...
    },
    {
        ...
        description: 'Quiet bed that sits under dialogue + SFX without fighting. Multi-second fades; 35Hz sub cleanup.',
        appliesTo: ['music'],
        chain: {
            normalizeLufs: -23,
            fadeInMs: 2000,
    ...
    },
    {
        ...
        description: 'Short punchy cue (boss reveal, item pickup). Loud, fast in / fast out, sub-bass thump emphasis.',
        appliesTo: ['music'],
        chain: {
            normalizeLufs: -12,
            fadeInMs: 0,
    ...
    // ── SFX ────────────────────────────────────────────────
    {
        id: 'sfx-default',
        name: 'SFX — default',
        description: 'Safe game-SFX default. Loudness-normalized to -16 LUFS with -1 dBTP true-peak guard.',
        appliesTo: ['sfx'],
        chain: {
            normalizeLufs: -16,
            truePeakDb: -1.0,
    ...
    },
    {
        ...
        description: 'Aggressive impact (hit / explode / crash). Loud, bass + presence boosts for "weight" + "crack".',
        appliesTo: ['sfx'],
        chain: {
            normalizeLufs: -12,
            truePeakDb: -1.0,
    ...
    },
    {
        ...
        description: 'UI sound that fires constantly. Micro-fades for click safety; sub-rumble removed (200Hz highpass) so the asset stays small + crisp.',
        appliesTo: ['sfx'],
        chain: {
            normalizeLufs: -16,
            fadeInMs: 5,
    ...
    },
    {
        ...
        description: 'Background ambient loop (wind / forest / city hum). Quiet so it doesn\'t fight dialogue; long fades for layering.',
        appliesTo: ['sfx'],
        chain: {
            normalizeLufs: -23,
            fadeInMs: 500,
...
export function findPostChainPreset(id) {
...
export function postChainPresetsFor(kind) {
...
export const AudioStyleConfigSchema = z.object({
    ...
    voiceCast: z
        ...
        localeVoices: z
            .record(LocaleIdSchema, z.object({
            voiceId: z.string().min(1),
            defaultModelId: z
                .enum([
                'eleven_multilingual_v2',
...
//# sourceMappingURL=audioGen.js.map